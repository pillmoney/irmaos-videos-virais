    ...
    <div className="p-8 max-w-7xl mx-auto w-full space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            href="/descobridor"
            className="inline-flex items-center justify-center gap-2 bg-zinc-900/60 hover:bg-zinc-900 text-zinc-300 hover:text-white border border-zinc-800/80 px-5 py-3 rounded-xl font-bold transition-all duration-200 hover:scale-[1.02]"
          >
